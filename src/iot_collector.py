...
def main():
    ...
    Chế độ hoạt động:
    - TEST MODE: Chạy test_functions() để kiểm tra các hàm
    - PRODUCTION MODE: Chạy vòng lặp thu thập dữ liệu liên tục
    """
    print("\n" + "=" * 80)
    ...
    print("  [1] TEST MODE - Kiểm tra các hàm")
    print("  [2] SINGLE COLLECTION - Thu thập 1 lần")
    print("  [3] CONTINUOUS MODE - Thu thập liên tục (mỗi 5 phút)")
    print("  [4] CUSTOM INTERVAL - Thu thập với khoảng thời gian tùy chỉnh")
    ...
    try:
        ...
        if mode == "1":
            ...
            # Continuous mode với interval 5 phút
            ...
            # Custom interval
            interval_input = input("Nhập khoảng thời gian (giây): ").strip()
            try:
